//
//  MPICustomAttributeViewController.m
//  MPITextKit_Example
//
...
#import "MPICustomAttributeViewController.h"
#import <MPITextKit/MPITextKit.h>
#import "MPIExampleAttachment.h"
#import "MPIExampleBackground.h"
#import "MPIExampleHelper.h"

@interface MPICustomAttributeViewController () <MPITextViewDelegate>

@end

@implementation MPICustomAttributeViewController
...
- (NSDictionary *)textView:(id<MPITextView>)textView activeTextAttributesWithLink:(MPITextLink *)link forAttributedText:(NSAttributedString *)attributedText inRange:(NSRange)characterRange {
